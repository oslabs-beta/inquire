    ...
    return(
      <div className="docContentSection" id="INIT">
        ...
        <h2>Initializing Topic</h2>
          <div className="p4">
            {`This section covers the initialization of Topic, namely how to 
            utilize Topic's command line interface (CLI).`}
          </div>
        ...
        {/* picture of the npm run topic init command */}

        <h4>Selecting Mode</h4>
          <div className="p4">
            {`Once you press enter, the next step is choosing the mode (1 or 2). Assuming you
            have a separate folder containing your Avro schema(s), Topic will eventually be scanning
            its contents to infer the GraphQL types and resolvers. While Topic will by default
        ...
        <h4>Entering Your Data Folder</h4>
          <div className="p4">
            {`Once you've chosen the appropriate mode, the last initialization step is to enter the
            location of the relevant Avro schema(s). Upon receiving the prompt, enter the absolute path
            of this folder into your terminal and press enter.`}
          </div>

          <div className="p4">
            {`Immediately following the command, you should see that a folder named "Topic" has
